...
class OpenAPIExectueViewController: FormViewController {
    ...
    func displayResult(_ response: GraphResponse) {
        guard response.isSucess == true else {
            resultRow.value = "Error[\(response.errorCode)]: \(response.errorMessage)"
...
protocol OpenAPIExecutor {
    func execute(params: [String: Any?], callback: @escaping GraphCallback)
}
...
class GetProfileExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        ZaloSDKFramework.sharedInstance.userProfile(callback: callback)
    }
}
...
class GetFriendListExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        ...
        ZaloSDKFramework.sharedInstance.getUserFriendList(from: offset, limit: limit, callback: callback)
    }
}
...
class GetInvitableFriendListExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        let offset = UInt(params["offset"] as? String ?? "") ?? 0
        let limit = UInt(params["limit"] as? String ?? "") ?? 50
        ZaloSDKFramework.sharedInstance.getUserInvitableFriendList(from: offset, limit: limit, callback: callback)
    }
}
...
class PostFeedExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        ...
        ZaloSDKFramework.sharedInstance.postFeed(withMessage: message, link: link, callback: callback)
    }
}
...
class SendMessageExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        ...
        let message = params["message"] as? String ?? ""
        let link = params["link"] as? String ?? ""
        ZaloSDKFramework.sharedInstance.sendMessage(to: to, message: message, link: link, callback: callback)
    }
}
...
class SendAppRequestExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        let to = params["to"] as? String ?? ""
        let message = params["message"] as? String ?? ""
        ZaloSDKFramework.sharedInstance.sendAppRequest(to: to, message: message, callback: callback)
    }
}
...
class SendOfficalAccountMessageExecutor : OpenAPIExecutor {
    ...
    func execute(params: [String : Any?], callback: @escaping GraphCallback) {
        ...
        ZaloSDKFramework.sharedInstance.sendOfficalAccountMessage(with: template, templateData: templateData, callback: callback)
    }
}
